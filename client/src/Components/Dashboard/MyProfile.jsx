    ...
    <div className='text-white p-7 flex flex-col gap-5  mx-auto'>
        ...
        <div className='flex justify-between  items-center w-[60%] bg-richblack-800 p-4 rounded-md border-[1px] border-richblack-700' >
            <div className='flex items-center gap-3'>
                ...
                <div>
                    ...
                    <p className='text-[12px] text-richblack-300 mt-1'> {user?.email}</p>
                </div>
            </div>
            <IconBtn
                      text="Edit"
       ...
       <div className='flex justify-between flex-col items-center w-[60%] bg-richblack-800 p-4 rounded-md border-[1px] border-richblack-700 gap-5 ' >
            <div className='w-full flex justify-between '>
                <p className='text-2xl text-richblack-25 font-bold'>Personal Details</p>
                <IconBtn
                text="Edit"
                onclick={() => {
                    navigate("/dashboard/settings")
            ...
            <div className='flex gap-28 w-full '>
                ...
                <div>
                    ...
                    <p className='text-richblack-25 mt-1'>{user?.additionalDetails?.gender ?? "Add Gender"}</p>
                </div>
               </div>
                      <div className='flex flex-col gap-4'>
                           <div>
                ...
                <div>
                    ...
                    <p className='text-richblack-25 mt-1'>{user?.additionalDetails?.contactNumber ?? "Add Contact Number"}</p>
                </div>
                <div>
                    <p className='text-richblack-300 '>Date of Birth</p>
                    <p className='text-richblack-25 mt-1'>{user?.additionalDetails?.dateOfBirth ?? "Add Date of Birth"}</p>
                </div>
               </div>
            </div>
        </div>
